...
VL_ATTR_COLD void Vsigdelay___024root__trace_init_sub__TOP__0(Vsigdelay___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+6,"delayed_signal", false,-1, 7,0);
    ...
    tracep->declBus(c+7,"w_addr", false,-1, 8,0);
    tracep->declBus(c+8,"r_addr", false,-1, 8,0);
    ...
    tracep->declBus(c+7,"count", false,-1, 8,0);
    ...
    tracep->declBus(c+7,"w_addr", false,-1, 8,0);
    tracep->declBus(c+5,"w_data", false,-1, 7,0);
    tracep->declBus(c+8,"r_addr", false,-1, 8,0);
...
VL_ATTR_COLD void Vsigdelay___024root__trace_full_sub_0(Vsigdelay___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullCData(oldp+6,(vlSelf->delayed_signal),8);
    bufp->fullSData(oldp+7,(vlSelf->sigdelay__DOT__w_addr),9);
    bufp->fullSData(oldp+8,((0x1ffU & ((IData)(vlSelf->sigdelay__DOT__w_addr) 
                                       - (IData)(vlSelf->offset)))),9);
    bufp->fullIData(oldp+9,(9U),32);
    bufp->fullIData(oldp+10,(8U),32);
    bufp->fullSData(oldp+11,(1U),9);
}
