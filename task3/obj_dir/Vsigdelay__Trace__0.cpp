...
void Vsigdelay___024root__trace_chg_sub_0(Vsigdelay___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->chgCData(oldp+5,(vlSelf->delayed_signal),8);
    bufp->chgSData(oldp+6,(vlSelf->sigdelay__DOT__w_addr),9);
    bufp->chgSData(oldp+7,((0x1ffU & ((IData)(vlSelf->sigdelay__DOT__w_addr) 
